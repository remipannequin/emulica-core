...
# ## END LICENSE
"""
This module enable running simulation/emulation model with various time
advances strategies (discrete-events, real-time, hybrid). It also support
running emulation model across a network.
"""
